...
export type SearchFishQuery = { fishList: { edges: Array<{ cursor: string, node?: { id: string, name: string, description: string, scientific: { species: string } } | null }>, pageInfo: { startCursor: string, endCursor: string, hasNextPage?: boolean | null } } };
...
export type SearchPlantQuery = { plantList: { edges: Array<{ cursor: string, node?: { id: string, name: string, description: string, scientific: { species: string } } | null }>, pageInfo: { startCursor: string, endCursor: string, hasNextPage?: boolean | null } } };
