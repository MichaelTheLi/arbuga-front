...
export type WaterReplacement = {
  waterParameters?: Maybe<WaterParameters>;
};

export type WaterReplacementInput = {
  waterParameters?: InputMaybe<WaterParametersInput>;
};

export type UserQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type UserQueryQuery = { me?: { id: string, login?: string | null, name: string, ecosystems?: Array<{ id: string, name: string, aquarium: { dimensions: { width: number, height: number, length: number } }, analysis?: Array<{ name: string, description: string, status: AnalysisStatus, messages: Array<{ name: string, description: string, status: AnalysisStatus }> }> | null, fish?: Array<{ count: number, fish: { id: string, name: string, description: string } }> | null, plants?: Array<{ count: number, plant: { id: string, name: string, description: string } }> | null, waterReplacement?: { waterParameters?: { ph: number, gh: number, kh: number } | null } | null, equipment: { filters?: Array<{ flow: number }> | null, heaters?: Array<{ power: number }> | null, lightingItems?: Array<{ lux: number }> | null } }> | null } | null };
...
export type UserRegisterMutation = { register?: { token?: string | null, user?: { id: string, login?: string | null, name: string, ecosystems?: Array<{ id: string, name: string, aquarium: { dimensions: { width: number, height: number, length: number } }, analysis?: Array<{ id: string, name: string, description: string, status: AnalysisStatus, messages: Array<{ id: string, name: string, description: string, status: AnalysisStatus }> }> | null, fish?: Array<{ count: number, fish: { id: string, name: string, description: string } }> | null, plants?: Array<{ count: number, plant: { id: string, name: string, description: string } }> | null, waterReplacement?: { waterParameters?: { ph: number, gh: number, kh: number } | null } | null, equipment: { filters?: Array<{ flow: number }> | null, heaters?: Array<{ power: number }> | null, lightingItems?: Array<{ lux: number }> | null } }> | null } | null } | null };
