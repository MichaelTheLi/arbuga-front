...
type FullAnimal_Fish_Fragment = { commonNames: Array<string>, description: string, scientific: { species: string }, environment: { waterParametersRange: { min: { temperature: number, chemical: { ph: number, gh: number, kh: number, ammonia: number, nitrite: number, nitrate: number } }, max: { temperature: number, chemical: { ph: number, gh: number, kh: number, ammonia: number, nitrite: number, nitrate: number } } } } } & { ' $fragmentName'?: 'FullAnimal_Fish_Fragment' };

type FullAnimal_Plant_Fragment = { commonNames: Array<string>, description: string, scientific: { species: string }, environment: { waterParametersRange: { min: { temperature: number, chemical: { ph: number, gh: number, kh: number, ammonia: number, nitrite: number, nitrate: number } }, max: { temperature: number, chemical: { ph: number, gh: number, kh: number, ammonia: number, nitrite: number, nitrate: number } } } } } & { ' $fragmentName'?: 'FullAnimal_Plant_Fragment' };
