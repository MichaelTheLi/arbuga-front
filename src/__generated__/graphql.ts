...
export type SearchFishQuery = { fishList: { edges: Array<{ cursor: string, node?: { id: string, name: string, description: string, scientific: { species: string }, environment: { waterParametersRange: { min: { temperature: number, chemical: { ph: number, gh: number, kh: number, ammonia: number, nitrite: number, nitrate: number } }, max: { temperature: number, chemical: { ph: number, gh: number, kh: number, ammonia: number, nitrite: number, nitrate: number } } } } } | null }>, pageInfo: { startCursor: string, endCursor: string, hasNextPage?: boolean | null } } };
...
export type SearchPlantQuery = { plantList: { edges: Array<{ cursor: string, node?: { id: string, name: string, description: string, scientific: { species: string }, environment: { waterParametersRange: { min: { temperature: number, chemical: { ph: number, gh: number, kh: number } }, max: { temperature: number, chemical: { ph: number, gh: number, kh: number } } } } } | null }>, pageInfo: { startCursor: string, endCursor: string, hasNextPage?: boolean | null } } };
